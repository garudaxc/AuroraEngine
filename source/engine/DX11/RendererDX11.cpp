...
namespace Aurora
{
	...
	class RenderStateObjectDx11 : public RenderStateObject
	{
	public:
		int32	Flag = 0;
		union {
	...
	RenderStateObject*	RendererDx11::CreateRasterizerState(bool FrontCounterClockwise, CullMode cullMode,
		FillMode fillMode, int DepthBias, int SlopeScaledDepthBias, bool AntialiasedLineEnable)
	{
		...
		RenderStateObjectDx11* obj = new RenderStateObjectDx11();
	...
	void RendererDx11::BindRasterizerState(RenderStateObject* handle)
	{
		RenderStateObjectDx11* obj = (RenderStateObjectDx11*)handle;
		assert(obj->Flag == (int)RenderStateFlag::RASTERIZER);
		ImmediateContext->RSSetState(obj->RasterizerState);
	}

	RenderStateObject*	RendererDx11::CreateBlendState(bool BlendEnable, BlendFactor SrcBlend, BlendFactor DestBlend,
	...
	void RendererDx11::BindBlendState(RenderStateObject* handle, const Color& BlendFactor)
	{
		RenderStateObjectDx11* obj = (RenderStateObjectDx11*)handle;

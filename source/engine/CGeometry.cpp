...
// get vertex info from buffer, ie. the adjacent triangle of vertex
    ...
    uint Vertex::NumElement(Vertex::ElemType type)
    {        
        switch (type)
        {
    ...
    static int32 CalcVertexLayoutStride(const Array<VertexLayoutItem>& layout)
    {
        int32 stride = 0;
    ...
    uint32 CVertexFactory::CalcVertexStride() const
    {
        return CalcVertexLayoutStride(mVertexLayouts);
    }
...
// 	
    ...
    uint CGeometry::GetIndexStride() const
    {
        ...
        return mStreams[streamIndex].nStride;
    }
    ...
    bool CGeometry::Load(const TiXmlNode* pXmlMesh)
    {
        ...
        mGeometryBuffer = GRenderDevice->CreateGeometryBuffer(this, CVertexFactoryPNTT::Instance);
...
//}
    ...
    static CVertexFactoryPNTT VertexFactoryPNTTIsntance;
    CVertexFactory* CVertexFactoryPNTT::Instance = &VertexFactoryPNTTIsntance;

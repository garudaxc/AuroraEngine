...
#define GL_GLES_PROTOTYPES 0
	...
	// wgl
	typedef BOOL (GL_APIENTRYP PFNWGLCHOOSEPIXELFORMATARBPROC)(HDC hdc, const int* piAttribIList,
	...
	typedef BOOL (GL_APIENTRYP PFNWGLSWAPINTERVALEXTPROC)(int interval);
